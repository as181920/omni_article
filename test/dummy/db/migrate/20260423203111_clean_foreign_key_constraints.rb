class CleanForeignKeyConstraints < ActiveRecord::Migration[7.0]
  def change
    ...
    remove_foreign_key :taggings, to_table: :tags, column: :tag_id

    remove_foreign_key :omni_account_postings, to_table: :omni_account_accounts, column: :account_id
    remove_foreign_key :omni_account_postings, to_table: :omni_account_entries, column: :entry_id
    ...
    remove_foreign_key :wxpay_public_keys, to_table: :wxpay_vendors, column: :vendor_id
    ...
    remove_foreign_key :org_users, to_table: :org_organizations, column: :organization_id
  end
end
